...
\begin{block}{Lemma}
Dato $G=(V,E)$ con $s$ sorgente e $t$ pozzo, per tutti i $v\in V\setminus\{s,t\}$ abbiamo che la lunghezza del cammino minimo fra $s$ e $v$ nella rete residua $G_f$ aumenta in maniera monotona durante l'esecuzione dell'algoritmo (in particolare, ad ogni aumento del flusso).
\end{block}
\end{frame}
